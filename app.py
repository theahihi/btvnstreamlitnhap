...
credit_score = st.sidebar.number_input('Điểm tín dụng', min_value=0, max_value=850, 300,step=1)
age = st.sidebar.number_input('Tuổi', min_value=18, max_value=100, step=1)
balance = st.sidebar.number_input('Số dư tài khoản', min_value=0.0, max_value=100000000,5000000,step=1000.0, format="%.2f")
estimated_salary = st.sidebar.number_input('Lương ước tính', min_value=0.0, max_value=100000000, 10000000 ,step=1000.0, format="%.2f")
